<%@ Page language="c#" Codebehind="TableList.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.TableList" %>
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA010</td>
											</TR>
											<TR>
										...
										<table cellPadding="0" align="center" border="0" class="form" cellSpacing="0">
											<TR valign="top">
												<TD class="formblank"><asp:datagrid id="TableGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="24" AutoGenerateColumns="False" AllowPaging="True" DataKeyField="TableID">
														<AlternatingItemStyle CssClass="grid2"></AlternatingItemStyle>
														<ItemStyle CssClass="grid"></ItemStyle>
														<HeaderStyle HorizontalAlign="Center" CssClass="gridheader"></HeaderStyle>
														<Columns>
															<asp:BoundColumn DataField="TableID" HeaderText="ID">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:HyperLinkColumn DataNavigateUrlField="TableID" DataNavigateUrlFormatString="TableInfo.aspx?id={0}" DataTextField="Tablename" HeaderText="Name"></asp:HyperLinkColumn>
															<asp:BoundColumn DataField="numberofseat" HeaderText="# of seats">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
														</Columns>
