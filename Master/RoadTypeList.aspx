...
<%@ Page language="c#" Codebehind="RoadTypeList.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.RoadTypeList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>RoadTypeList</title>
									...
									<TD vAlign="middle" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA110</td>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2">Road Type List
										...
										<TABLE class="form" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR valign="top">
												<TD class="formblank"><asp:datagrid id="RoadTypeGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="24"
														AutoGenerateColumns="False" AllowPaging="True" DataKeyField="RoadTypeID">
...
<Columns>
<asp:BoundColumn DataField="roadTypeID" HeaderText="TypeID">
...
<asp:HyperLinkColumn DataNavigateUrlField="RoadTypeID" DataNavigateUrlFormatString="RoadTypeInfo.aspx?id={0}" DataTextField="roadTypeName" HeaderText="Road Type Name"></asp:HyperLinkColumn>
</Columns>
