<%@ Page language="c#" Codebehind="SmartclientInfo.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SmartclientInfo" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>SmartclientInfo</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formgroup" colSpan="2">Smartclient Information</TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblSmartclientID" runat="server" EnableViewState="False">Smartclient ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtSmartclientID" runat="server"></asp:label></TD>
											</TR>
                                            <TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblSmartclientDescription" runat="server" EnableViewState="False">Smartclient Name</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtSmartclientDescription" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblSmartclientLocalPrinter" runat="server" EnableViewState="False">Local Printer</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtSmartclientLocalPrinter" runat="server"></asp:label></TD>
											</TR>
											<TR>
										...
										<TABLE class="formstatus" id="Table5" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formstatus" align="center" colSpan="2"><asp:label id="LblConfirmDelete" runat="server" Visible="False" CssClass="error">Are you sure to delete this Smartclient?</asp:label></TD>
											</TR>
											<TR>
