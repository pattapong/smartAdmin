<%@ Page language="c#" Codebehind="RoadEdit.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.RoadEdit" %>
									...
									<TD vAlign="middle" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA122</td>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2">Edit Road</TD>
											</TR>
										</TABLE>
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 20px"><asp:label id="LblAreaID" runat="server" EnableViewState="False">Road ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 20px"><asp:label id="TxtRoadID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblRoadName" runat="server" EnableViewState="False">Road Name</asp:label></TD>
												<TD class="formvalue"><asp:textbox id="TxtRoadName" runat="server" Columns="50" CssClass="form" MaxLength="50"></asp:textbox>
													<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="TxtRoadName">Please specify Road Name</asp:RequiredFieldValidator></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblRoadType" runat="server" EnableViewState="False">Road Type</asp:label></TD>
												<TD class="formvalue">
													<asp:dropdownlist id="LstRoadType" runat="server" CssClass="form" Width="133px"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblArea" runat="server" EnableViewState="False"> Area</asp:label></TD>
												<TD class="formvalue">
