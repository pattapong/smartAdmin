<%@ Page language="c#" Codebehind="DescriptionConfigEdit.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.DescriptionConfigEdit" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>Edit Description's Config</title>
									...
									<TD vAlign="middle" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA081</td>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2">Edit Description's Config</TD>
											</TR>
										</TABLE>
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formgroup" colSpan="2">Description's Config&nbsp;Information</TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblTypeName" runat="server" EnableViewState="False"> Type Name</asp:label></TD>
												<TD class="formvalue"><asp:label id="TxtTypeName" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblDescriptionID" runat="server" EnableViewState="False"> Description ID</asp:label></TD>
												<TD class="formvalue"><asp:label id="TxtDescriptionID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblDescription" runat="server" EnableViewState="False"> Description</asp:label></TD>
												<TD class="formvalue"><asp:textbox id="TxtDescription" runat="server" Columns="50" CssClass="form" MaxLength="50"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="TxtDescription"
														ErrorMessage="Please specify Description"></asp:requiredfieldvalidator></TD>
											</TR>
											<TR>
												<TD class="form">
													<asp:label id="LblLinkID" runat="server" EnableViewState="False"> Link ID</asp:label></TD>
												<TD class="formvalue">
													<asp:label id="TxtLinkID" runat="server"></asp:label></TD>
											</TR>
											<TR>
