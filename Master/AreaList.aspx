...
<%@ Page language="c#" Codebehind="AreaList.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.AreaList" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										...
										<TABLE class="form" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR valign="top">
												<TD class="formblank"><asp:datagrid id="AreaGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="24"
														AutoGenerateColumns="False" AllowPaging="True" DataKeyField="AreaID">
...
<Columns>
<asp:BoundColumn DataField="AreaID" HeaderText="ID">
...
<asp:HyperLinkColumn DataNavigateUrlField="AreaID" DataNavigateUrlFormatString="AreaInfo.aspx?id={0}" DataTextField="AreaName" HeaderText="Name"></asp:HyperLinkColumn>
<asp:HyperLinkColumn DataNavigateUrlField="areaid" DataNavigateUrlFormatString="AreaInfo.aspx?id={0}" DataTextField="AreaTypeName" HeaderText="Area Type"></asp:HyperLinkColumn>
</Columns>
