<%@ Page language="c#" Codebehind="RoadTypeAdd.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.RoadTypeAdd" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>AddRoadType</title>
								...
								<TD vAlign="middle" width="100%">
									<TABLE class="formtitle" cellSpacing="0" cellPadding="0" align="center" border="0">
										<TR>
											...
											<td class="formpageid" align="right">SAMA111</td>
										</TR>
										<TR>
											<TD class="formsubheader" colSpan="2">Add Road Type</TD>
										</TR>
									</TABLE>
									<TABLE class="form" cellSpacing="1" cellPadding="0" align="center" border="0">
										...
										<TR>
											<TD class="form"><asp:label id="LblRoadTypeID" runat="server" EnableViewState="False"> RoadType ID</asp:label></TD>
											<TD class="formvalue"><asp:label id="TxtRoadTypeID" runat="server"></asp:label></TD>
										</TR>
										<TR>
											<TD class="form"><asp:label id="LblRoadTypeName" runat="server" EnableViewState="False">Road Type Name</asp:label></TD>
											<TD class="formvalue"><asp:textbox id="TxtRoadTypeName" runat="server" Columns="50" CssClass="form" MaxLength="50"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="TxtRoadTypeName"
													ErrorMessage="Please specify Road Type Name"></asp:requiredfieldvalidator></TD>
										</TR>
										<TR>
