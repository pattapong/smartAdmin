<%@ Page language="c#" Codebehind="TimeInfo.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.TimeInfo" %>
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA023</td>
											</TR>
											<TR>
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblShiftID" runat="server" EnableViewState="False"> Time ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtTimeID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblDayfrom" runat="server" EnableViewState="False">Time Name</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtTimeName" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblShiftTimefrom" runat="server" EnableViewState="False"> Time from</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtTimefrom" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblShiftTimeto" runat="server" EnableViewState="False"> Time to</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtTimeto" runat="server"></asp:label></TD>
											</TR>
											<TR>
										...
										<TABLE class="formstatus" id="Table5" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formstatus" align="middle" colSpan="2"><asp:label id="LblConfirmDelete" runat="server" Visible="False" CssClass="error"> Are you sure to delete this time?</asp:label></TD>
											</TR>
											<TR>
