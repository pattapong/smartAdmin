...
<%@ Page language="c#" Codebehind="EmployeeTypeInfo.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.EmployeeTypeInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>EmployeeTypeInfo</title>
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAEM023</td>
											</TR>
											<TR>
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblEmpTypeID" runat="server" EnableViewState="False">Employee Type ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtEmpTypeID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblEmpTypeName" runat="server" EnableViewState="False">Employee Type Name</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtEmpTypeName" runat="server"></asp:label></TD>
											</TR>
											<TR>
