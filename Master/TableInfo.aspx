...
<%@ Page language="c#" Codebehind="TableInfo.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.TableInfo" %>
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												...
												<td class="formpageid" align="right">SAMA013</td>
											</TR>
											<TR>
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblTableID" runat="server" EnableViewState="False"> Table ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtTableID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px">
													<asp:label id="Label1" runat="server" EnableViewState="False"> Table Name</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtTableName" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblNumOfSeat" runat="server" EnableViewState="False">Number of seats</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtNumberOfSeat" runat="server"></asp:label></TD>
											</TR>
											<TR>
										...
										<TABLE class="formstatus" id="Table5" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formstatus" align="middle" colSpan="2"><asp:label id="LblConfirmDelete" runat="server" Visible="False" CssClass="error">Are you sure to delete this employee type?</asp:label></TD>
											</TR>
											<TR>
