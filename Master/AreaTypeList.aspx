<%@ Page language="c#" Codebehind="AreaTypeList.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.AreaTypeList" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>AreaTypeList</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="formsubheader" colSpan="2">Area Type List
										...
										<TABLE class="form" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR valign="top">
												<TD class="formblank"><asp:datagrid id="AreaTypeGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="24"
														AutoGenerateColumns="False" AllowPaging="True" DataKeyField="AreaTypeID">
...
<Columns>
<asp:BoundColumn DataField="AreaTypeID" HeaderText="Type ID">
...
<asp:HyperLinkColumn DataNavigateUrlField="AreaTypeID" DataNavigateUrlFormatString="AreaTypeInfo.aspx?id={0}" DataTextField="areaTypeName" HeaderText="Area Type Name"></asp:HyperLinkColumn>
</Columns>
