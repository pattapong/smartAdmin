...
<%@ Page language="c#" Codebehind="AreaTypeEdit.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.AreaTypeEdit" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 20px"><asp:label id="LblAreaTypeID" runat="server" EnableViewState="False">Area Type ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 20px"><asp:label id="TxtAreaTypeID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblAreaTypeName" runat="server" EnableViewState="False">Area Type Name</asp:label></TD>
												<TD class="formvalue"><asp:textbox id="TxtAreaTypeName" runat="server" Columns="50" CssClass="form" MaxLength="50"></asp:textbox>
													<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="TxtAreaTypeName">Please specify Area Type Name</asp:RequiredFieldValidator></TD>
											</TR>
											<TR>
