<%@ Page language="c#" Codebehind="AreaInfo.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.AreaInfo" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 22px"><asp:label id="LblAreaID" runat="server" EnableViewState="False">Area ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 22px"><asp:label id="TxtAreaID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblAreaName" runat="server" EnableViewState="False">Area Name</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtAreaName" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form" style="HEIGHT: 21px"><asp:label id="LblAreaType" runat="server" EnableViewState="False">Area Type</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 21px"><asp:label id="TxtAreaType" runat="server"></asp:label></TD>
											</TR>
											<TR>
...
<asp:Button id=BtnDelete runat="server" EnableViewState="False" CssClass="formbtn" Visible="False" Text="Delete"></asp:Button>
