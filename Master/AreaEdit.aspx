<%@ Page language="c#" Codebehind="AreaEdit.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.AreaEdit" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="middle" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="formsubheader" colSpan="2">Edit Area</TD>
											</TR>
										</TABLE>
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											...
											<TR>
												<TD class="form" style="HEIGHT: 20px"><asp:label id="LblAreaID" runat="server" EnableViewState="False">Area ID</asp:label></TD>
												<TD class="formvalue" style="HEIGHT: 20px"><asp:label id="TxtAreaID" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblAreaName" runat="server" EnableViewState="False">Area Name</asp:label></TD>
												<TD class="formvalue"><asp:textbox id="TxtAreaName" runat="server" Columns="50" CssClass="form" MaxLength="50"></asp:textbox>
													<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="TxtAreaName">Please specify Area Name</asp:RequiredFieldValidator></TD>
											</TR>
											<TR>
												<TD class="form"><asp:label id="LblAreaType" runat="server" EnableViewState="False">Area Type</asp:label></TD>
												<TD class="formvalue">
