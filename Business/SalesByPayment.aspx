<%@ Page language="c#" Codebehind="SalesByPayment.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesByPayment" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Sales By Payment Type</TD>
												<td class="formpageid" align="right">SABU030</td>
											</TR>
											<!-- Start of tab report -->
