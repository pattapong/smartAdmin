...
<%@ Page language="c#" Codebehind="ReserveByPeriodDetail.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.ReserveByPeriodDetail" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Reserve By Period&nbsp;Detail</TD>
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formgroup" colSpan="2">Reserve&nbsp;Info</TD>
											</TR>
											<TR vAlign="top">
