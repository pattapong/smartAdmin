...
<%@ Page language="c#" Codebehind="MenuChangeOptionDetail.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.MenuChangeOptionDetail" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Menu's Changing Option Detail</TD>
										...
										<TABLE class="form" id="Table4" cellSpacing="1" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formgroup" colSpan="2">Option Info</TD>
											</TR>
											<TR vAlign="top">
