<%@ Page language="c#" Codebehind="SalesByDiscount.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesByDiscount" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Sales By Discount</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Sales By Discount</TD>
												<td class="formpageid" align="right">SABU050</td>
											</TR>
											<!-- Start of tab report -->
