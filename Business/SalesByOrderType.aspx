<%@ Page language="c#" Codebehind="SalesByOrderType.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesByOrderType" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Sales By Order's Type</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Sales By Order's Type</TD>
												<td class="formpageid" align="right">SABU040</td>
											</TR>
											<!-- Start of tab report -->
											...
											<TR>
												<TD class="formsubheader2" colSpan="2"><nobr>
														<asp:panel id="PanelDaily" runat="server" Width="250px" Visible="False" Height="9px">&nbsp;Day From 
<asp:TextBox id="TxtDayFrom" runat="server" CssClass="form" Width="75px"></asp:TextBox>&nbsp;To 
<asp:TextBox id="TxtDayTo" runat="server" CssClass="form" Width="75px"></asp:TextBox></asp:panel><asp:panel id="PanelYearly" runat="server" Width="200px" Visible="False" Height="9px">&nbsp;Year From 
<asp:TextBox id="TxtYearFrom" runat="server" CssClass="form" Width="51px"></asp:TextBox>&nbsp;To 
<asp:TextBox id="TxtYearTo" runat="server" CssClass="form" Width="47px"></asp:TextBox></asp:panel><asp:panel id="PanelMonthly" runat="server" Width="318px" Visible="False" Height="9px">&nbsp;Month 
                  From&nbsp; 
...
<asp:TextBox id="TxtYear" runat="server" CssClass="form" Width="47px"></asp:TextBox></asp:panel><asp:button id="BtnShow" runat="server" CssClass="formbtn" EnableViewState="False" Text="Show"></asp:button></nobr></TD>
											</TR>
										</TABLE>
										<TABLE class="form2" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR vAlign="top">
												<TD class="formblank"><asp:datagrid id="ReportGrid" runat="server" CssClass="grid" AllowPaging="True" PageSize="22" CellPadding="0" Width="100%">
