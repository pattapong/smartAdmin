...
<%@ Page language="c#" Codebehind="ServiceOrderServe.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.ServiceOrderServe" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Service Order-Serve Time</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Service : Order-Serve Time</TD>
