...
<%@ Page language="c#" Codebehind="TimeStampByEmp.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.TimeStampByEmp" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Employee's TimeStamp</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Employee's TimeStamp</TD>
												<td class="formpageid" align="right">SABU120</td>
											</TR>
											<!-- Start of tab report -->
											...
											<!-- End of tab report -->
											<TR>
												<TD class="formsubheader2" colSpan="2">
													<nobr>
...
<asp:TextBox id="TxtYear" runat="server" CssClass="form" Width="47px"></asp:TextBox></asp:panel></nobr> <nobr>
														Employee
														<asp:DropDownList id="LstEmployee" runat="server" CssClass="form"></asp:DropDownList>
														<asp:button id="BtnShow" runat="server" CssClass="formbtn" EnableViewState="False" Text="Show"></asp:button>
													</nobr>
												</TD>
											</TR>
										</TABLE>
										<TABLE class="form2" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR vAlign="top">
												<TD class="formblank">
													<asp:datagrid id="ReportGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="22" AllowPaging="True">
