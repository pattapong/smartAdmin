<%@ Page language="c#" Codebehind="SalesByEmp.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesByEmp" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Sales By Waiter</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Sales By Waiter</TD>
												<td class="formpageid" align="right">SABU020</td>
											</TR>
											<!-- Start of tab report -->
