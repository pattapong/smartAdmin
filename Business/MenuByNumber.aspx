<%@ Page language="c#" Codebehind="MenuByNumber.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.MenuByNumber" %>
<%@ Register TagPrefix="cc1" Namespace="SmartAdmin.Controls" Assembly="smartAdminControls" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Menu By Number</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Menu By Number</TD>
												<td class="formpageid" align="right">SABU080</td>
											</TR>
											<!-- Start of tab report -->
...
<asp:TextBox id="TxtYear" runat="server" CssClass="form" Width="47px"></asp:TextBox></asp:panel></nobr><nobr>
														<asp:DropDownList id="LstType" runat="server" CssClass="form" AutoPostBack="True">
															<asp:ListItem Value="Top 10">Top 10</asp:ListItem>
															<asp:ListItem Value="Top 20" Selected="True">Top 20</asp:ListItem>
															<asp:ListItem Value="Least 10">Least 10</asp:ListItem>
															<asp:ListItem Value="Least 20">Least 20</asp:ListItem>
															<asp:ListItem Value="0">Not Order</asp:ListItem>
														</asp:DropDownList>
														<asp:DropDownList id="LstPeriod" runat="server" CssClass="form" AutoPostBack="True"></asp:DropDownList>&nbsp;<asp:button id="BtnShow" runat="server" Text="Show" EnableViewState="False" CssClass="formbtn"></asp:button></nobr></TD>
											</TR>
										</TABLE>
