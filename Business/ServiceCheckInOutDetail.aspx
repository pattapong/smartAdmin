...
<%@ Page language="c#" Codebehind="ServiceCheckInOutDetail.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.ServiceCheckInOutDetail" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Service Check In Out Detail</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Service : Time Detail (Check In - Check Out)</TD>
												<td class="formpageid" align="right">SAME013</td>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2">
													<asp:label id="TxtEnglish" runat="server" CssClass="formsubheader"></asp:label></TD>
											</TR>
										</TABLE>
										<TABLE class="form" id="Table4" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
