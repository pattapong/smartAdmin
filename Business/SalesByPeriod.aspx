...
<%@ Page language="c#" Codebehind="SalesByPeriod.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesByPeriod" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Sales By Period</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Sales By Period</TD>
												<td class="formpageid" align="right">SABU010</td>
											</TR>
											<!-- Start of tab report -->
											...
											<!-- End of tab report -->
											<TR>
												<TD class="formsubheader2" colSpan="2"><nobr><asp:panel id="PanelDaily" runat="server" Height="9px" Visible="False" Width="250px">&nbsp;Day From 
