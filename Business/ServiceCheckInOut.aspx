<%@ Page language="c#" Codebehind="ServiceCheckInOut.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.ServiceCheckInOut" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Service : Time (Check In - Check Out)</TD>
