...
<%@ Page language="c#" Codebehind="PrintSlipOrder.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.PrintSlipOrder" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Menu's Changing Option</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Print Slip By Order</TD>
												<td class="formpageid" align="right">SABU150</td>
											</TR>
											<!-- Start of tab report -->
...
<asp:TextBox id="TxtYear" runat="server" CssClass="form" Width="47px"></asp:TextBox></asp:panel></nobr><nobr>
														...
														</asp:DropDownList>&nbsp;<asp:button id="BtnShow" runat="server" Text="Show" EnableViewState="False" CssClass="formbtn"></asp:button></nobr></TD>
											</TR>
										</TABLE>
