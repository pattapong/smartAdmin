...
<%@ Page language="c#" Codebehind="MenuByEmp.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.MenuByEmp" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Take Order By Cancel</title>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Take Order By Waiter</TD>
												<td class="formpageid" align="right">SABU130</td>
											</TR>
											<!-- Start of tab report -->
