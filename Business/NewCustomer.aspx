...
<%@ Page language="c#" Codebehind="NewCustomer.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.NewCustomer" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">New Customer (Take Out &amp; Reserve)</TD>
												<td class="formpageid" align="right">SABU190</td>
											</TR>
											<!-- Start of tab report -->
