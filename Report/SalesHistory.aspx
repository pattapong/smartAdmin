<%@ Page language="c#" Codebehind="SalesHistory.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesHistory" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">History's Sales</TD>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2">
													...
													<BR>
													Period&nbsp;
													<asp:dropdownlist id="LstPeriod" runat="server" CssClass="form"></asp:dropdownlist>&nbsp; 
													Payment Type
													<asp:dropdownlist id="LstPayment" runat="server" CssClass="form"></asp:dropdownlist>
													&nbsp;
											...
											<TR valign="top">
												<TD class="formblank"><asp:datagrid id="ReportGrid" runat="server" CssClass="grid" Width="100%" CellPadding="0" PageSize="24" AutoGenerateColumns="False" AllowPaging="True">
														...
														<Columns>
															...
															<asp:BoundColumn DataField="paymentmethodname" HeaderText="Payment">
																<ItemStyle HorizontalAlign="Left"></ItemStyle>
															</asp:BoundColumn>
