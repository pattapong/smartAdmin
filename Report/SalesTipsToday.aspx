<%@ Page language="c#" Codebehind="SalesTipsToday.aspx.cs" AutoEventWireup="false" Inherits="SmartAdmin.SalesTipsToday" %>
								...
								<TR vAlign="top">
									...
									<TD vAlign="center" width="100%">
										<TABLE class="formtitle" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR>
												<TD class="formheader">Today's SalesTip</TD>
											</TR>
											<TR>
												<TD class="formsubheader" colSpan="2"></TD>
											</TR>
										</TABLE>
										<TABLE class="form" cellSpacing="0" cellPadding="0" align="center" border="0">
											<TR vAlign="top">
												<TD class="formblank"><asp:datagrid id="ReportGrid" runat="server" CssClass="grid" AllowPaging="True" PageSize="24" CellPadding="0" Width="100%">
